...
const getIcon = (iconType: Resource["icon"]) => {
  switch (iconType) {
    case "book":
      return <BookIcon />;
    case "document":
...
const MUNResources: React.FC<MUNResourcesProps> = ({
  tagline = "Get Prepared",
  title = "Delegate Resources",
  subtitle = "Everything you need to prepare for a successful conference experience.",
  resources = DEFAULT_RESOURCES,
  viewAllHref = "/modelun/resources",
}) => {
  ...
  // Duplicate resources for seamless loop
        ...
        >
          ...
          >
            {duplicatedResources.map((resource, index) => (
              ...
              >
                <div className={styles.cardIcon}>{getIcon(resource.icon)}</div>
